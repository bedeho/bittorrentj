 ...
 */
public class NonMatchingIdFieldInMessageException extends MessageCreationException {
    ...
    public NonMatchingIdFieldInMessageException(MessageId readId, MessageId expectedId) {
